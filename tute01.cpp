...
int main() 
{
    ...
    std :: cout <<"Enter a length in cm : ";//input the length in centimeter
    std :: cin >> cm;//read the length
    inches = cm / 2.54;//Calculations
    std :: cout <<"Length in inches is " << inches << std :: endl;//display the length in inches
    return 0;
}  
